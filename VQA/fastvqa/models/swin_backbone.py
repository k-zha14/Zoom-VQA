...
class SwinTransformer3D(nn.Module):
    ...
    def __init__(
        ...
        print('base x size:', self.base_x_size)
    ...
    def init_weights(self, pretrained=None):
        print('Load 3D pretrained weights:', self.pretrained)
        print('Load 2D pretrained and inflated to 3D:', self.pretrained2d)
